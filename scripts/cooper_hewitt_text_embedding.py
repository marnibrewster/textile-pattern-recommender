...
DATA_PATH = Path("data/cooper_hewitt_formatted_data.json")
OUTPUT_DIR = Path("data/cooper_hewitt_text_embeddings")
...
for start_index in range(0, total, batch_size):
  ...
  filename = OUTPUT_DIR / f"cooper_hewitt_text_embeddings_batch_{batch_num}.json"
